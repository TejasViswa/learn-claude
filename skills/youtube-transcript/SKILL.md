...
```bash
python3 ~/.claude/skills/youtube-transcript/fetch_transcript.py "<youtube_url>"
```
...
- For non-English videos or videos with captions disabled, the script will fail; consider a manual transcript as a fallback.
